...
<body>
	...
	<center><h1 style="font: 34px Poppins;"> En Tendance </h1></center>
...
<div class="">
	<div class="container">	
		<section  id ="sbox" class="box search" style="margin-right:21%; position: sticky; padding-top: 3%; ">
			<form method="GET" action="/tendance">
			    				...
			    				<div class="card-body">
			    				  ...
			    				  <c:out value="${e.getDescription()}" escapeXml="false"></c:out>
									...
									<div id="heart" class="alert alert-success" style="display:none;">
										<h1 style="font-size: 15px; padding: -4px -4px -4px -4px;">L'article est ajoute a votre liste lire plus tard</h1>	
										</div> 
								</div>
			    			</div>
			    		</div>	
